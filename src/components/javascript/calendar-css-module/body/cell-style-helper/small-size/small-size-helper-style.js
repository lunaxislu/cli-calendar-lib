 ...
 * @returns
 */
function getSmallSizeMonthMembershipStatus(month, currentDate) {
 ...
 */
function getSmallSizeDateRelativeToToday(day) {
  const today = dayjs();
 ...
 * @params currentDate: The current date in the calendar (Dayjs)
 */
function getSmallSizeCalendarDisplayState(month, currentDate) {
  return month.isSame(currentDate, "M")
 ...
 * @params day: The selected date (Dayjs)
 */
function getSmallSizeDayType(day) {
